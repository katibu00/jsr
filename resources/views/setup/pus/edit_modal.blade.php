        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="text-center mb-3">
                    <h3 class="mb-2">Edit Polling Unit</h3>
                </div>
                ...
                <form id="addNewForm" class="row g-3">
                    ...
                    <div class="add_item">
                        <div class="form-group  mb-2">
                            <div class="col-md-12">
                                <input type="text" id="edit_name" class="form-control" placeholder="Enter PU Name" />
                            </div>
                        </div>
                        <div class="form-group  mb-2">
                            <div class="col-md-12">
                                <input type="number" id="edit_voters" class="form-control" placeholder="Registered Voters" />
                            </div>
                        </div>
